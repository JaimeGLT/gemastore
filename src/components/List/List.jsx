...
const List = ({ selectedCategories, valorRange, sort }) => {
    ...
    if (pathname === '/productos') {
        url = `/products?populate[img][fields][0]=url&populate[img2][fields][1]=url&fields[2]=esNuevo&fields[3]=titulo&fields[4]=precio&fields[5]=precio_con_descuento${selectedCategories?.map(item =>`&filters[categorias][id][$eq]=${item}`).join('&')}&[filters][precio][$lte]=${valorRange}&sort[0]=precio:${sort}`
